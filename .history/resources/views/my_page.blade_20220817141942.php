...
@foreach ($users->user_bookings->bookings as $user_booking)
<div class="my-page">
  <div class="booked__box">
    <div class="booked__ttl">
      <h2>予約状況</h2>
    </div>
    @if(count($user_booking->shops) >= 1)
    @php
    $i=1
    @endphp
    @foreach ($user_booking->bookings as $booking)
  ...
  <div class="liked__box">
    ...
    @if(count($user_likes->shops) >= 1)
    @foreach ($user_likes->shops as $shop)
