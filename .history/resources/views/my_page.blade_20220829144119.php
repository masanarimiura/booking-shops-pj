    ...
    <div class="liked__box">
      ...
      <div class="shop__card">
        ...
        <div class="card__content">
          <div class="card__content__inter">
            <h2 class="card__ttl">{{$like->shop->name}}</h2>
            <div>
              <p>✭</p>
              @php
              $avg_rating = round($like->shop->avg_rating, 1);
              @endphp
              @if($avg_rating == 0)
              <p>-</p>
              @else
        ...
        <div class="card__content">
          <div class="card__content__inter">
            ...
            <div>
              <p>✭</p>
              @php
              $avg_rating = round($booking->shop->avg_rating, 1);
              @endphp
              @if($avg_rating == 0)
              <p>-</p>
              @else
          ...
          <div>
            <p>来店日時：{{$booking->datetime->format('Y-m-d H:i')}}</p>
            <form method="get" action="{{ route('rating') }}" >
              @csrf
              <input type="text" name="shop_id" value="{{$booking->shop->id}}" style="display:none">
              <input type="text" name="shop_name" value="{{$booking->shop->name}}" style="display:none">
              <input type="text" name="shop_booking_date" value="{{$booking->datetime->format('Y-m-d')}}" style="display:none">
              <input type="text" name="shop_booking_time" value="{{$booking->datetime->format('H:i')}}" style="display:none">
              <input type="text" name="shop_booking_number" value="{{$booking->number}}" style="display:none">
