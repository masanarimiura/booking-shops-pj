      ...
      <form action="" method="post">
        ...
        <div class="form__box">
          ...
          <div class="select__box">
            <select name="" oninput="recheckBooking()" oninput="recheckBooking()" id="booking-time">
          ...
          <div class="select__box">
            <select name="" oninput="recheckBooking()">
