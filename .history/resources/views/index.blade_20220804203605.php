    ...
    <div class="card__content">
      ...
      <div class="card__content__inner">
        ...
        @if(Auth::check())
          @php
          print_r(Auth::id());
          print_r($shop->likes->toArray());
          function print_boolean_22($val) {
            echo ($val)? 'true':'false';
          }
          print_boolean_22($shop->likes->toArray()[array_search(Auth::id(), array_column($shop->likes->toArray(), 'user_id'))]);
        @endphp
        @else
