    ...
    <div class="modal-delete-error">
      <div class="modal__content">
        <div class="modal__content-inner">
          ...
          <p>※下記のご予約の変更ができませんでした。</p>
          <p>ご予約の変更を希望される場合は、{{ $error }}</p>
          @endforeach
          <div class="modal__booked-data">
            <table>
              <tr>
        ...
        <div class="modal__content-inner">
          ...
          <div class="rating-inner">
            <div class="rating-star-box" id="stars">
              <span class="star" data-star="1">あ</span>
              <span class="star" data-star="2">あ</span>
              <span class="star" data-star="3">あ</span>
              <span class="star" data-star="4">あ</span>
              <span class="star" data-star="5">あ</span>
            </div>
          ...
          <form action="{{ route('destroyBooking') }}" method="post">
            ...
            <div>
              <input type="text" name="booking_id" value="{{$booking->id}}" style="display:none">
              <input type="submit" value="評価せずにマイページへ戻る" class="return-btn">
            </div>
          </form>
        </div>
      </div>
