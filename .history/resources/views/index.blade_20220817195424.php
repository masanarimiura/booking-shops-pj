...
<div class="header__box">
  ...
  <div class="search__box">
    <form method="get" action="{{ route('search') }}" name="search_shops_form" onchange="searchShops()">
      @if($request)
      <select name="area_id" id="search_area_id" value="{{ $request->area_id }}">
        <option value="">All area
        <option value="13">東京都
        <option value="27">大阪府
        <option value="40">福岡県
      </select>
      <select name="genre_id" value="{{ $request->genre_id }}">
      ...
      <input type="text" name="search_text" value="<select name="area_id" id="search_area_id" value="{{ $request->area_id }}">
        <option value="">All area
        <option value="13">東京都
        <option value="27">大阪府
        <option value="40">福岡県
      ...
      <input type="text" name="search_text" value="{{ $request->search_text }}"  placeholder="search ...">"  placeholder="search ...">
      @endif
    </form>
  </div>
</div>
