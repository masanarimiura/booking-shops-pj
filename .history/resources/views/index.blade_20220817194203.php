...
<div class="header__box">
  ...
  <div class="search__box">
    <form method="get" action="{{ route('search') }}" name="search_shops_form" onchange="searchShops()">
      <select name="area_id" id="search_area_id" value="$request->search_text$request->search_text$request->search_text">
      ...
      <input type="text" name="search_text" value="{{ old('search_text') }}"  placeholder="search ...">
    </form>
  </div>
</div>
