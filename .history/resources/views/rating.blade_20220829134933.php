  ...
  <div class="modal__content">
    <div class="modal__content-inner">
      ...
      @csrf
        ...
        <div>
          <input type="text" name="shop_id" value="{{$shop_id}}" style="display:none">
      ...
      <div class="modal__booked-data">
        <table>
          ...
          <tr>
            <td>Date</td>
            <td>{{$shop->booking->datetime->format('Y-m-d')}}</td>
          </tr>
          <tr>
            <td>Time</td>
            <td>{{$shop->booking->datetime->format('H:i')}}</td>
          </tr>
          <tr>
            <td>Number</td>
            <td>{{$shop->booking->number}}人</td>
          </tr>
        </table>
      </div>
      <div>
