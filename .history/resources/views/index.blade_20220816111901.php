    ...
    <div class="card__content">
      ...
      <div class="card__content__inner">
        <form method="get" action="{{ route('detail') }}">
          @csrf
          <input type="text" value="{{$shop->image_url}}" style="display:none">
          <input type="text" value="{{$shop->name}}" style="display:none">
          <input type="text" value="{{$shop->area->name}}" style="display:none">
          <input type="text" value="{{$shop->genre->name}}" style="display:none">
          <input type="text" value="{{$shop->comment}}" style="display:none">
          <input type="text" value="{{$shop->comment}}" style="display:none">
          <div>
