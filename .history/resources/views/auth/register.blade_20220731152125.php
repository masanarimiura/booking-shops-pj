    ...
    <div class="from__box">
        ...
        <form action="{{ route('register') }}" method="post">
            ...
            <div class="input__box">
                ...
                <x-input type="text" placeholder="Username" id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name')" required autofocus>
            </div>
            <div class="input__box">
                <img src="{{ asset('/image/email.png')}}" alt="No image">
                <x-input type="text" placeholder="Email" id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email')" required>
            </div>
            <div class="input__box">
