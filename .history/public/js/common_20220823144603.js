...
if (document.getElementsByClassName('openBtn-rating')) {
  for (let i = 0; i < document.getElementsByClassName('openBtn-rating').length; ++i) {
    const openBtn = document.getElementsByClassName('openBtn-rating')[i];mentsByClassName('modal-rating')[i];
    openBtn.addEventListener('click', () => {
      modal.style.display = 'block';
    })
    closeBtn.addEventListener('click', () => {
