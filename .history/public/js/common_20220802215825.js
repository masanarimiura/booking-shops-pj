...
function recheckBooking() {
  ...
  document.getElementById("booking-date").innerHTML = inputDate;
  
  const bookingTime = document.getElementById("today");
  const inputValue = bookingTime.value;
  document.getElementById("booking-date").innerHTML = inputValue;
}