...
class ShopsTableSeeder extends Seeder
{
    public function run()
    {
        Shop::create([
            ...
            'image_url'=>"torage/image/sushi.jpg",
        ]);
        Shop::create([
            'name' => '牛助',
            'area_id' => '27',
            ...
            'image_url'=>"asset('storage/image/yakiniku.jpg')",
        ]);
        Shop::create([
            'name' => '戦慄',
            'area_id' => '40',
            ...
            'image_url'=>"asset('storage/image/izakaya.jpg')",
        ]);
        Shop::create([
            'name' => 'ルーク',
            'area_id' => '13',
            ...
            'image_url'=>"asset('storage/image/italian.jpg')",
        ]);
        Shop::create([
            'name' => '志摩屋',
            'area_id' => '40',
            ...
            'image_url'=>"asset('storage/image/ramen.jpg')",
        ]);
        Shop::create([
            'name' => '香',
            'area_id' => '13',
        ...
        Shop::create([
            ...
            'image_url'=>"asset('storage/image/sushi.jpg')",
        ]);
        Shop::create([
            'name' => '晴海',
            'area_id' => '27',
