...
Route::post('/shop/like', [ShopController::class, 'like'])->middleware(['auth'])->name('like');
Route::post('/shop/dislike', [LikeController::class, 'dislike'])->middleware(['auth'])->name('dislike');
