...
Route::post('/like', [IndexController::class, 'like'])->middleware(['auth'])->name('shop_like');
Route::post('/dislike', [IndexController::class, 'dislike'])->middleware(['auth'])->name('shop_dislike');
