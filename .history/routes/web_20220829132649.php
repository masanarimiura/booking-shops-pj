...
// ↓設計書修正必要
Route::get('/rating', [RatingController::class, 'rating'])->middleware(['auth'])->name('rating');
Route::post('/rating', [MyPageController::class, 'rating'])->middleware(['auth'])->name('ratingSubmit');
