...
// ↓設計書修正必要
Route::get('/my-page/rating', [MyPageController::class, 'rating'])->middleware(['auth'])->name('rating');
Route::post('/my-page/rating', [MyPageController::class, 'rating'])->middleware(['auth'])->name('ratingSubmit');
Route::get('/thanks-rating', [ThanksController::class, 'thanksRating'])->middleware(['auth']);
