...
Route::post('/my-page/destroy-booking', [BookController::class, 'destroyBooking'])->middleware(['auth'])->name('destroyBooking');
Route::post('/my-page/dislike', [MyPageController::class, 'dislikeMyPage'])->middleware(['auth'])->name('my_page_dislike');
