...
Route::post('/like', [MyPageController::class, 'Like'])->middleware(['auth'])->name('like');
Route::post('/dislike', [MyPageController::class, 'destroyLike'])->middleware(['auth'])->name('dislike');
