...
Route::post('/shop/like', [ShopController::class, 'like'])->middleware(['auth'])->name('shop_like');
Route::post('/shop/dislike', [ShopController::class, 'dislike'])->middleware(['auth'])->name('shop_dislike');
